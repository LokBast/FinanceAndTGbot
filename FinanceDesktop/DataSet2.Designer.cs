...
namespace FinanceDesktop.DataSet2TableAdapters {
    ...
    public partial class CategoryTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Category] WHERE (([idCategory] = @Original_idCategory) AND ([N" +
                "ameCategory] = @Original_NameCategory))";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Category] SET [NameCategory] = @NameCategory WHERE (([idCategory] =" +
                " @Original_idCategory) AND ([NameCategory] = @Original_NameCategory));\r\nSELECT i" +
                "dCategory, NameCategory FROM Category WHERE (idCategory = @idCategory)";
